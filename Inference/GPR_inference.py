...
if __name__ == '__main__':
    ...
    # predicted embeddings of the test set with all the fold0 models
    ...
    # predicted embeddings of the test set with all the fold1 models
    ...
    # predicted embeddings of the test set with all the fold2 models
    ...
    # predicted embeddings of the test set with all the fold3 models
    ...
    # predicted embeddings of the test set with all the fold4 models
    ...
    gpr_path = '../input/embeddings/fx_embeddings_and_folds/fx_embeddings/gpr_rbf/best_9_gpr_model'  # the trained GPR model path
    y_path = '../input/embeddings/fx_embeddings_and_folds/fx_embeddings/gpr_rbf/best_9_y.npy'  # the original target path
    emb_path = '../input/embeddings/fx_embeddings_and_folds/fx_embeddings/gpr_rbf/best_9_embeddings.npy'  # the concatenated oof embeddings for 9 models
    ...
    # average the predictions of different folds
